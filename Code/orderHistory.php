...
<body>
	<div class="header">
		<p style="color:white;font-size: 30px; float: left;margin-left: 50px;font-family: Times New Roman;">Debjyoti Stationary Portal</p>
		<ul>
	...
	?>
			<div class="noorderhistory">
				<p>There is no order history.</p><br><br>
	...
	?>
			<tr>
				...
				<td style="color:#f44336;"><b>DELIVERED</b></td>
			</tr>
	<?php
		}
	?>
